...
const PRODUCTS = [
  {
    ...
    description: "Классический белый тартин с золотистой хрустящей корочкой и воздушным мякишем. На натуральной закваске, без дрожжей.",
    weight: "430 г",
    price: "400 ₽",
  ...
  {
    id: 2,
    name: "Десертный хлеб из ржаной и пшеничной муки с фруктами и орехами",
    description: "Тёмный насыщенный хлеб с курагой, черносливом, миндалём и кунжутом. Сладкий и сытный — идеален к чаю или кофе.",
    weight: "600 г",
    price: "420 ₽",
  ...
  {
    id: 3,
    name: "Ржано-пшеничный хлеб с чёрным кунжутом и семенами подсолнечника",
    description: "Плотный ароматный хлеб из смеси ржаной и пшеничной муки с чёрным кунжутом и семенами подсолнечника. Долго остаётся свежим.",
    weight: "430 г",
    price: "500 ₽",
