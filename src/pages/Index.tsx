...
const PROCESS_STEPS = [
  {
    num: "Шаг 1",
    title: "Замес",
    desc: "Смешиваем муку, воду и живую закваску вручную — до тех пор, пока тесто не начнёт тянуться и дышать. Никакого миксера: только руки, мука и время.",
  },
  {
    num: "Шаг 2",
    title: "Ферментация и расстой",
    desc: "Тесто складывается несколько раз и уходит на объёмную ферментацию 12–16 часов. Затем буханка формуется и укладывается в корзину для расстоя, застеленную льняной тканью — здесь она набирает форму и характер ещё несколько часов.",
  },
  {
    num: "Шаг 3",
    title: "Надрез и посадка",
    desc: "Перед выпечкой пекарь делает надрезы лезвием-ламе — они задают направление раскрытия корочки. Буханка перекладывается на раскалённый пекарский камень, застеленный пекарской бумагой.",
  },
  {
    num: "Шаг 4",
    title: "Выпечка на камне",
    desc: "Печь раскалена до 240–260 °C. В первые минуты подаётся пар — он не даёт корке затвердеть раньше времени, и хлеб раскрывается по надрезу. Камень держит жар снизу, создавая ту самую хрустящую подовую корочку.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-[var(--cream)] font-golos">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-5 text-[#e8d5b8] font-golos leading-relaxed">
                <p>
                  Хлеб на живой закваске — это один из самых полезных продуктов на вашем столе.
                  За 12–16 часов ферментации разрушается фитиновая кислота, расщепляется глютен,
                  и все питательные вещества зерна усваиваются в полной мере.
                </p>
                <p>
                  Низкий гликемический индекс означает, что хлеб не вызывает скачков сахара в крови
                  и не откладывается в жир. Вы насыщаетесь надолго и не набираете лишний вес —
                  даже при регулярном употреблении.
                </p>
                <p>
      ...
      <section id="process" className="min-h-screen flex items-center relative overflow-hidden">
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{ backgroundImage: `url(https://cdn.poehali.dev/projects/552ff5ae-1510-4e54-8df4-2f4097d4cd94/files/8b0369ea-3078-48b3-b9ce-ce188d107955.jpg)` }}
        />
