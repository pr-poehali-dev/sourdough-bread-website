...
export const PRODUCTS = [
  ...
  },
  {
    ...
    emoji: "🌾",
    composition: "Живая ржаная закваска, ржаная мука обдирная, пшеничная мука, вода, семена подсолнечника, чёрный кунжут, соль морская.",
    details: "Ржаной хлеб — это особый разговор. Здесь живая ржаная закваска задаёт тон: она густая, тягучая, с глубоким кисловатым характером. Тесто долго зреет при комнатной температуре, постепенно набирая вкус и аромат. Семена подсолнечника поджариваются заранее — до лёгкого золотистого цвета и орехового запаха, — а затем вмешиваются в тесто вместе с чёрным кунжутом. Готовая буханка расстаивается в корзине, обтянутой пекарской тканью, а затем выпекается на раскалённом камне. Корочка получается тёмной, почти угольной, а мякиш — плотным, влажным и невероятно сытным. Хранится до 5–6 дней, становясь с каждым днём ещё глубже по вкусу.",
  },
  {
    id: 4,
