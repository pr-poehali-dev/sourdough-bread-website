...
export const PRODUCTS = [
  ...
  },
  {
    ...
    weight: "450 г",
    price: "420 ₽",
    image: "https://cdn.poehali.dev/projects/552ff5ae-1510-4e54-8df4-2f4097d4cd94/bucket/a465dbdd-13f8-441d-bd2b-08c16af6eb9c.jpg",
    emoji: "🌾",
    composition: "Ржаная мука обдирная, живая ржаная закваска, вода питьевая, чёрный кунжут, соль морская.",
    details: "Плотный ароматный ржаной хлеб, испечённый по традиционному рецепту на живой закваске. Тесто ферментируется не менее 16 часов — это придаёт мякишу насыщенный кисловатый вкус и тёмный цвет. Чёрный кунжут вмешивается в тесто вручную и рассыпается по верхней корочке перед выпечкой: он обогащает хлеб кальцием, железом и антиоксидантами. Выпекается в форме при 220°C с паровым увлажнением. Хлеб долго остаётся свежим — до 6–7 дней при комнатной температуре.",
  },
  {
    id: 6,
